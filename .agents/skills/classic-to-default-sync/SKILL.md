...
description: >-
  Inspect a given commit's web/classic changes and sync features or fixes to
  web/default. Use for classic/default comparison, parity audit, porting,
  quality improvements, bug fixes, and requests supplying a commit hash with
  classic/default comparison intent.
---
